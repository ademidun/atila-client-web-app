...
import jothamImage from './assets/jotham.jpg';
...
function TeamMemberCard({ teamMember }) {
    ...
    return (
        <div className="card shadow max-width-md-30 m-1 p-2">
            ...
            {teamMember.link_url && <Link to={`/profile/${teamMember.link_url}`}>{teamMember.link_type}</Link>}
...
function Team() {
    return (
        <div className="container p-3">
            ...
            <div className="col-sm-12 col-md-8 px-0" style={{ fontSize: 'larger' }}>
