        ...
        <React.Fragment>
            ...
            <div className="container mt-5">
                <div className="card shadow p-3">
                    ...
                    <p><br /><br /></p>
                    <p><strong>Can Students outside of Canada and the USA use Atila?</strong></p>
                    <p>Students outside of Canada and the USA may use Atila to find scholarships, but they are not currently able to use the Atila Direct applications feature.
                        ...
                        We want to open up this feature to as many students as possible so if you&rsquo;re outside of Canada and want to use Atila,
                        contact us (you can use the chat in the bottom right) and let us know what country you&rsquo;re in so we know what countries we should prioritize in launching next.</p>
                </div>
            </div>
        </React.Fragment>
    );
