...
export function ApplicationsTable({ applications, scholarship, selectWinner, isScholarshipOwner, assignReviewerButton }) {
...
export const getApplicationUsernamesByAttribute = (application, attributeName="assigned_reviewers") => {
    ...
    console.log({application, assigned_reviewers, user_scores});
