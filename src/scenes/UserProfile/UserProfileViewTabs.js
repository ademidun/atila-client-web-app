...
function UserProfileViewTabs({ isProfileEditable = false, loggedInUserProfile, userProfile: { user: userIdInView } }) {
    ...
    useEffect(() => {
        UserProfileAPI.getUserContent(userIdInView, 'blogs')
            .then(res => {
                setBlogs(res.data.blogs);
            });
        UserProfileAPI.getUserContent(userIdInView, 'essays')
            .then(res => {
                setEssays(res.data.essays);
            });
        UserProfileAPI.getUserContent(userIdInView, 'contributions')
            .then(res => {
...
export default connect(mapStateToProps)(UserProfileViewTabs);