...
import { getErrorMessage, handleError, scrollToElement } from "../../services/utils";
...
import ApplicationDetailView from "./ApplicationDetail/ApplicationDetailView";
    ...
    render() {
        ...
        let viewModeContent = (<>
                ...
                <ApplicationDetailView 
                    ...
                    questions={scholarship.user_profile_questions}
                    responses={application.user_profile_responses} />
                {applicationWalletDisplay}
                <h2>Scholarship Questions</h2>
                <ApplicationDetailView 
                    scholarship={scholarship} 
                    application={application} 
                    questions={scholarship.specific_questions}
                    responses={application.scholarship_responses} />
        </>);
